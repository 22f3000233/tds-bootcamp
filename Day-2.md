...
--- Before Day-2 ---
I already knew basic terminal commands like ls and cd and had used GitHub before.
--- 
...
--- After Day-2 ---
I learned how environment variables work, how commands can be chained using pipes, and how shell configuration files affect terminal behavior.
---

--- Feedback (Suggestions for the TDS Team) ---
The exercises were useful and practical.
---
